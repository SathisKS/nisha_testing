    ...
    */
    public function getGuaranteeStatus(Basket $basket, $paymentKey, $orderAmount = 0, $billingInvoiceAddrId = 0, $shippingInvoiceAddrId = 0)
    {
        ...
        if ($guaranteePayment == 'true') {
            ...
            $this->getLogger(__METHOD__)->error('bas bill', $basket->customerInvoiceAddressId);
            $this->getLogger(__METHOD__)->error('bas ship', $basket->customerShippingAddressId);
            $this->getLogger(__METHOD__)->error('pass bill', $billingInvoiceAddrId);
            $this->getLogger(__METHOD__)->error('pass ship', $shippingInvoiceAddrId);
